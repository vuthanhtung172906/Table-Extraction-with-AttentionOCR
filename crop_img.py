...
def getLengthWidth(biggest):
    width =  ((biggest[0][0][0]- biggest[1][0][0])**2 + (biggest[0][0][1]-biggest[1][0][1])**2)**0.5
    length  =  ((biggest[0][0][0]- biggest[2][0][0])**2 + (biggest[0][0][1]-biggest[2][0][1])**2)**0.5
    return length, width
...
def crop_imgFunc(img):
    ...
    imgWarpColored = cv2.warpPerspective(img, matrix, (int(width), int(length)))
